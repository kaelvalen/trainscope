...
## [0.7.1] - General Bugfix & Maintenance Release

> This release also ships the changes previously planned as 0.6.0 (PELT score
> semantics) and 0.7.0 (write-path performance), which were never released
> separately; 0.7.1 is the first release containing them.
